...
Latest version: https://github.com/dprojects/Woodworking/blob/master/Tools/showModelSize.py
...
info += '<br><br>'
info += '<b>Note:</b> '
info += 'They are not dimensions taken from objects, they are occupied space in 3D by the objects. '
