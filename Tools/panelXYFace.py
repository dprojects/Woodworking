...
if selectedLen == 0:
	QtGui.QMessageBox.information(None,"panelXYFace","Please select face to create panel and try again.")
	...
	try:
		...
		QtGui.QMessageBox.information(None,"panelXYFace","Please select face not object and try again.")
	...
	panel = FreeCAD.activeDocument().addObject("Part::Box", "panelXYFace")
