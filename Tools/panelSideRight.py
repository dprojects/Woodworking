...
if selectedLen == 0:
	QtGui.QMessageBox.information(None,"panelSideRight","Please select face to create side panel adjusted to right and try again.")
	...
	try:
		...
		QtGui.QMessageBox.information(None,"panelSideRight","Please select face not object and try again.")
