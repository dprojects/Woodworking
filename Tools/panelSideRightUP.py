...
if selectedLen == 0:
	QtGui.QMessageBox.information(None,"panelSideRightUP","Please select face to create side panel adjusted to right and up and try again.")
	...
	try:
		...
		QtGui.QMessageBox.information(None,"panelSideRightUP","Please select face not object and try again.")
