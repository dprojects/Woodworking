...
try:
	...
	if sv1 == "" or sv2 == "" or obj == "":
		
		try:
			sv1 = FreeCADGui.Selection.getSelectionEx()[0].SubObjects[0]
			sv2 = FreeCADGui.Selection.getSelectionEx()[1].SubObjects[0]
			obj = FreeCADGui.Selection.getSelection()[2]
		except:
			skip = 1
	...
	MagicPanels.setPlacement(obj, X, Y, Z, r, centerAnchor)
