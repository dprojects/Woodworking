...
if selectedLen != 3:
	QtGui.QMessageBox.information(None,"panelYZCover","Please select 3 faces to create cover panel and try again.")
	...
	try:
		...
		QtGui.QMessageBox.information(None,"panelYZCover","Please select 3 faces not object and try again.")
	...
	if s1 > 0 and s2 > 0 and s3 > 0:
		panel = FreeCAD.activeDocument().addObject("Part::Box", "panelYZCover")
		panel.Length = s1
		panel.Width = s2
		panel.Height = s3
		...
		QtGui.QMessageBox.information(None,"panelYZCover","Can't create this type of panel at selected faces. Try other type of panel here.")
