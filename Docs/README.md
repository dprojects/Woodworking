...
> * improve descriptions to get better context for AI auto translation (all tools GUI) <br>
> * allow download translations for patches from release branch (loadMenu) <br>
> * add translations generated by AI script for all languages <br>
> * change default panels to whole chipboard sheet 2800 x 2070 (MagicPanels) <br>
