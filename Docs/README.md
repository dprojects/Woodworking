...
* **Width of transport space:** This is the width of the cargo space, for example, the width of the trunk in a car. By default, it is set to the width of my new Kia Picanto.
* **Length of transport space:** This is the length of the cargo space, for example, the length of the trunk of a car towards the front of the car. By default, it is set to the length of the trunk space in my new Kia Picanto with the seats folded down.
