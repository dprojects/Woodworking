...
> * improve descriptions to get better context for AI auto transation (all tools GUI) <br>
...
* **Steps of lumber thickness:** this option allows you to set the thresholds to which the wood thickness value will be rounded in the case of the [r - raw wood order](https://github.com/dprojects/Woodworking/tree/master/Docs#main-report) cut list in the "rough" section. The thickness of each board from the "finish" section will be rounded to the first encountered threshold from this list that corresponds to the value of the global variable `MagicPanels.gSawmillSteps`.
...
* **board foot:** volume in milimeters will be recalculated to board foot (1ft × 1ft × 1in).
