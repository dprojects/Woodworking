...
| Name | FreeCAD code | Google AI code | Translation status |
| :--- | :--: | :--: | :--- |
| Afrikaans | af | af | Translated automatically by AI script. |
| Arabic | ar | ar | Translated automatically by AI script. |
| Basque | eu | eu | Translated automatically by AI script. |
| Belarusian | be | be | Translated automatically by AI script. |
| Bulgarian | bg | bg | Translated automatically by AI script. |
| Catalan | ca | ca | Translated automatically by AI script. |
| Chinese (Simplified) | zh-CN | zh-CN | Translated automatically by AI script. |
| Chinese (Traditional) | zh-TW | zh-TW | Translated automatically by AI script. |
| Croatian | hr | hr | Translated automatically by AI script. |
| Czech | cs | cs | Translated automatically by AI script. |
| Danish | da | da | Translated automatically by AI script. |
| Dutch | nl | nl | Translated automatically by AI script. |
| English | en | en | Development language. |
| Filipino | fil | tl | Translated automatically by AI script. |
| Finnish | fi | fi | Translated automatically by AI script. |
| French | fr | fr | Translated automatically by AI script. |
| Galician | gl | gl | Translated automatically by AI script. |
| Georgian | ka | ka | Translated automatically by AI script. |
| German | de | de | Translated automatically by AI script. |
| Greek | el | el | Translated automatically by AI script. |
| Hungarian | hu | hu | Translated automatically by AI script. |
| Indonesian | id | id | Translated automatically by AI script. |
| Italian | it | it | Translated automatically by AI script. |
| Japanese | ja | ja | Translated automatically by AI script. |
| Korean | ko | ko | Translated automatically by AI script. |
| Lithuanian | lt | lt | Translated automatically by AI script. |
| Malay | ms | ms | Translated automatically by AI script. |
| Norwegian | no | no | Translated automatically by AI script. |
| Polish | pl | pl | My native language supported manually since `0.23` release, since `3.0` version created by AI script and fixed by me. |
| Portuguese | pt-PT | pt | Translated automatically by AI script. |
| Portuguese (Brazilian) | pt-BR | pt | Same AI code, not translated. |
| Romanian | ro | ro | Translated automatically by AI script. |
| Russian | ru | ru | Translated automatically by AI script. |
| Serbian | sr | sr | Translated automatically by AI script. |
| Serbian (Latin) | sr-CS | sr | Same AI code, not translated.
| Slovak | sk | sk | Translated automatically by AI script. |
| Slovenian | sl | sl | Translated automatically by AI script. |
| Spanish | es-ES | es | Translated automatically by AI script. |
| Spanish (Argentina) | es-AR | es | Same AI code, not translated. |
| Swedish | sv-SE | sv | Translated automatically by AI script. |
| Turkish | tr | tr | Translated automatically by AI script. |
| Ukrainian | uk | uk | Translation added by [Andrii Semerun](https://github.com/dprojects/Woodworking-translations/pull/1) since 2.0 release. |
| Vietnamese | vi | vi | Translated automatically by AI script. |
...
> [!TIP]
> Since Woodworking workbench release 0.22 there is `translations update tool` available under drop down menu 
> `Woodworking -> Download and update all translations`. This tool will automatically download all available 
> `.qm` files from [github.com/dprojects/Woodworking-translations](https://github.com/dprojects/Woodworking-translations) 
> repository into `translations` folder for you Woodworking workbench version.
